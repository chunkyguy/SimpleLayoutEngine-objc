#
#  Be sure to run `pod spec lint SimpleLayoutEngine.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author    = "Sidharth Juyal"
  spec.social_media_url   = "https://twitter.com/chunkyguy"
